    ...
    **** Contacts ****
    ...
    # Get birthday  
     ...
     # Add birthday 
        ...
        birthday = input("Their birthday in MM/DD/YY: ")
        print(f"\n{assistant.add_birthday(name,birthday)}")
    #Remove birthday  
    elif user_command == "6":
        print("Here are your birthday contacts: \n")
        for name in assistant.get_birthdays():
          print(name)
        user_input = input("\nWhich birthday would you like to remove? ")
    ...
    #Add contact
        ...
        title = input(f"What is {name}'s job title? ")
